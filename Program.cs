...
namespace GuitarAppOOAD
{
    public class Program
    {
        ...
        //public static GuitarSpecifications AskUserForSpecifications()
        //{
        //    GuitarSpecifications specifications = new GuitarSpecifications();

        //    Console.Write("Enter the number of strings: ");
        //    specifications.NumberOfStrings = int.Parse(Console.ReadLine());

        //    Console.Write("Enter the Guitar Builder from\nFENDER,\nMARTIN,\nGIBSON,\nCOLLINGS,\nOLSON,\nRYAN,\nPRS,\nANY:- ");
        //    specifications.GuitarBuilder = Console.ReadLine();
